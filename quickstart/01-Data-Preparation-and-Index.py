...
#df = spark.table("wiki_data.fifa_2022.embeddings_text")
#df = df.withColumn("id", monotonically_increasing_id())
#df.write.format("delta").mode("overwrite").option("mergeSchema", "true").saveAsTable("wiki_data.fifa_2022.embeddings_text")
...
question = "Which Team won the Fifa 2022 World Cup?"
