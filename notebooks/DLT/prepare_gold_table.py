...
df_spark = spark.table(f"{CATALOG_NAME}.{SCHEMA_NAME}.wiki_sections_clean")
...
df_spark.write.mode("overwrite").saveAsTable(f"{CATALOG_NAME}.{SCHEMA_NAME}.wikipedia_strings")
